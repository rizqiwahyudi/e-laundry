...
$a = $_POST['tgl_awal'];
$b = $_POST['tgl_akhir'];
$q = mysqli_query($conn, "SELECT * FROM pengeluaran where tanggal between '$a' and '$b'");
...
$pdf->Text(10, 5.8, 'LAPORAN BULANAN PENGELUARAN');
...
$que = mysqli_query($conn, "SELECT sum(nominal) as jml from pengeluaran where tanggal between '$a' and '$b'");
