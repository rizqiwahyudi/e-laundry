		...
		<table class="table table-bordered table-hover">
			...
			$waktu1 = date('Y-m-d');
				...
				<tr>
					...
					<td>
						<a href="include/pengeluaran/delete.php?id=<?= $row['id_pengeluaran'] ?>" class="badge badge-danger"></a>
						<a href="index.php?page=editpengeluaran&id=<?= $row['id_pengeluaran'] ?>" class="badge badge-success"></a>
					</td>
				</tr>
				<?php endwhile; ?>
			</tbody>
