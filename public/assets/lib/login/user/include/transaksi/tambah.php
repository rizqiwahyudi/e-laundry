		...
		<div class="panel-heading"> 
			...
			<form method="post" class="ac-form" action="include/transaksi/acition_tambah.php">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="jumlah_bayar1" id="prd_total1" placeholder="total">
				</div>
				<div class="form-group">
					<label>Total</label>
					<input type="text" class="form-control" name="jumlah_bayar" id="prd_total" placeholder="total">
				</div>
				<div class="form-group">
