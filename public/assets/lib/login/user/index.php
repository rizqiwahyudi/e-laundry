...
<head>
    ...
    <link rel="stylesheet" href="assetss/select2-master/dist/css/select2.min.css"/>
<!-- <link rel="stylesheet" type="text/css" href="js/DataTables/datatables.min.css"/> -->
    ...
    <body class="fixed-left">
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa fa-user"></i> <span> Karyawan </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        if (!$page) {
                          ...
                          //LAPORAN
                                    case 'laporan':
                                        include 'include/transaksi/form_laporan.php';
                                        break;

                                    case 'laporan_pengeluaran';
                                        include 'include/pengeluaran/form_laporan.php';
                                        break;
                                    case 'laporan-karyawan';
                                        include 'include/karyawan/form_laporan.php';
                                        break;

                                    case 'laporan-karyawan1':
                                        include 'include/karyawan/form_laporan1.php';
                                        break;

                                    case 'laporan-absen':
                                        include 'include/absensi/form_laporan.php';
                                        break;
        ...
        <script src="assetss/select2-master/dist/js/select2.min.js"></script>
