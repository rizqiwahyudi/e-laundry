...
<head>
    ...
    .judul {font-family: billabong;}
    .judul button {font-family: calibri; width: 100%; margin-top: 8px; margin-bottom: 8px;}
    .subjudul {font-size: 15px; color: grey; font-family: calibri; font-weight: 600; margin-top: 0px;}
    .fom input{
      padding: 13px; padding-left: 15px; width: 100%;
      border : 1px solid #e6e6e6; border-radius: 5px; font-size: 10px;
    }
    .bungkus {border: 1px solid #e6e6e6; padding: 20px; padding-bottom: 8px; background: #fff; margin-top: 70px; box-sizing: border-box;}
    .input {
     position: relative;
   }
   .input input:focus {
...
<script src="{{ asset('/assets/lib/login/admin/assetss/js/jquery.min.js') }}"></script>
